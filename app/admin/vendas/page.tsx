...
export default function Vendas() {
  ...
  function entrar() {
    if (s === "62981796690" || s === "GRAZI2026") {
      ...
      setOk(true)
    } else alert("Senha 62981796690")
  }
  function gerar() {
    if (!nome) { alert("Nome"); return }
    const cod = "LIBERADO-" + Math.floor(1000 + Math.random() * 9000)
    const nova = { id: Date.now(), nome, zap, codigo: cod, data: new Date().toLocaleDateString() }
  ...
  return (
    <div style={{ padding: 16 }}>
      <h1>VENDAS R$97 - AMERICO - PIX: 62981796690</h1>
      <a href="/">Voltar</a> | <a href="/admin">Admin Candidatos</a>
      <div style={{ marginTop: 16, background: "white", border: "2px solid black", padding: 16 }}>
        <h3>GERAR CODIGO CLIENTE</h3>
